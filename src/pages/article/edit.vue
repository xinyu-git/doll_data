...
<view class="page">
  <view class="weui-cell_bd weui-cell_primary">
    <form bindsubmit="formSubmit" >
      <textarea id="textarea" maxlength="20" bindinput="watchTextarea" value="{{editContent}}" class="weui-textarea my-textarea" placeholder="请输入文本" placeholder-class='placeholdercolor' auto-focus></textarea>
...
export default class UploadVideo extends wepy.page {
  ...
  watchTextarea(event) {
    ...
    this.max = 20-event.detail.value.length;
